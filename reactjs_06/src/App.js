...
class App extends Component {
  constructor(props) {
    ...
    this.add_product_name = React.createRef();
  }
  ...
  AddProductEvent = () => {
    console.log(this.add_product_name.current.value);
  }
    ...
    return (
      ...
      <nav className="navbar navbar-inverse">
        <div className="container-fluid">
          <div className="navbar-brand">Refs</div>
        </div>
      </nav>  
          ...
          <div className="row">
            ...
            <div className="panel panel-primary">
              ...
              <div className="form-group">
                ...
                <input type="text" className="form-control" id="product_name" placeholder="Input product name" ref={ this.add_product_name } />
              </div>
              <button type="submit" className="btn btn-primary" onClick={ this.AddProductEvent }>Save</button>
              </div>
            </div>
            </div>
            <div className="col-xs-12 col-sm-10 col-md-12 col-lg-12">
